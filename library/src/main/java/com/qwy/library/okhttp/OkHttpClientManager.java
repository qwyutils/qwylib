package com.qwy.library.okhttp;
...
public class OkHttpClientManager
{
     ...
     * @param callback
     */
    private void _downloadAsyn(final String url, final String destFileDir, final ResultCallbackFile callback)
    {
        final Request request = new Request.Builder()
                .url(url)
                .build();
    ...
    public static void downloadAsyn(String url, String destDir, ResultCallbackFile<String> callback)
    {
    ...
    /**
     * 文件下载返回*/
    private void sendFailedStringCallback(final Request request, final Exception e, final ResultCallbackFile callback)
    {
        mDelivery.post(new Runnable()
        {
            @Override
    ...
    /**
     * 文件下载成功*/
    private void sendSuccessResultCallback(final Object object, final ResultCallbackFile callback)
    {
        mDelivery.post(new Runnable()
        {
            @Override
     ...
     * @param <T>
     */
    private <T> void sendProgressCallBack(final double total, final double current, final ResultCallbackFile<T> callBack) {
        mDelivery.post(new Runnable() {
            @Override
            public void run() {
                if (callBack != null) {
    ...
    public static abstract class ResultCallbackFile<T>
    {
        Type mType;

        public ResultCallbackFile()
        {
            mType = getSuperclassTypeParameter(getClass());
        }
